...
class CategoriesActivity : ComponentActivity() {
    ...
    private val categotiesApi = connect.create(CategoriesApiMethods::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LaunchedEffect(Unit) {
                categoriesList.value = categotiesApi.getAllCategories().body()!!.categories
            }
            ...
            Surface(
                ...
                Text(
                    text = "Виды сырья и условия приёма",
                    color = newGreen,
                ...
                Box(
                    ...
                    if (categoriesList.value.isEmpty() == false) {
                        LazyColumn(
                            ...
                            itemsIndexed(
                                ...
                                categoriesListItem(categy = item, context = context)
                            }
...
@Composable
private fun categoriesListItem(categy: CategoryModel, context: Context) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(7.dp)
        ...
        Box(
            ...
            Row(
                ...
                Column(
                    ...
                    val rules = "\t- " + categy.rules.split(";").joinToString(separator = "\n\t- ")
                    Text(
                        text = rules,
                        fontFamily = FontFamily(Font(R.font.jetbrainsmono_regular)),
                        modifier = Modifier.padding(bottom = 4.dp)
                    )
                    if (categy.not_take != null) {
                        Text(
                            text = "Не принимается:",
                            color = Color.Red,
                            fontFamily = FontFamily(Font(R.font.jetbrainsmono_bold))
                        ...
                        val not_take =
                            "\t- " + categy.not_take.split(";").joinToString(separator = "\n\t- ")
                        Text(
                            text = not_take,
                            fontFamily = FontFamily(Font(R.font.jetbrainsmono_regular))
                        )
                ...
                val decodedBytes = Base64.getDecoder().decode(categy.img)
